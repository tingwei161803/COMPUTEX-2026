...
(function () {
  ...
  var I18N = {
    en: { footer: "Unofficial fan-made guide · Not affiliated with COMPUTEX, TAITRA or TCA · All details follow official announcements.",
          close: "Close", menu: "On this page" },
    zh: { footer: "非官方整理 · 與 COMPUTEX、TAITRA、TCA 無關 · 一切資訊以官方公告為準。",
          close: "關閉", menu: "本頁導覽" }
  };
      ...
      var svg =
        '<svg viewBox="0 0 ' + W + " " + H + '" role="img" ' +
          ...
          '<defs><linearGradient id="barGrad" x1="0" y1="0" x2="0" y2="1">' +
            '<stop class="bar-stop-0" offset="0"></stop>' +
            '<stop class="bar-stop-1" offset="1"></stop>' +
          "</linearGradient></defs>" +
  ...
  /* =======================================================================
     SCROLL REVEAL — gentle fade-up as blocks enter the viewport.
     The class is added BY js, so if js never runs the content stays visible.
     ===================================================================== */
  var revealObserver = null;
  function setupReveal() {
    if (revealObserver) { revealObserver.disconnect(); revealObserver = null; }
    var targets = [].slice.call(
      document.querySelectorAll("#sections .section-head, #sections [data-item]")
    );
    ...
    targets.forEach(function (el, i) {
      ...
      el.style.transitionDelay = (Math.min(i % 6, 5) * 55) + "ms";  // cascade
    });
